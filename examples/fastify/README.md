...
Server-Side Rendering (SSR) application using Fastify with `@thednp/rpc` for automatic RPC generation.
...
- [Fastify Adapter](https://github.com/thednp/rpc/wiki/adapters.md#fastify)
