...
Server-Side Rendering (SSR) application using Hono with `@thednp/rpc` for automatic RPC generation.
...
- [Hono Adapter](https://github.com/thednp/rpc/blob/master/wiki/adapters.md#hono)
