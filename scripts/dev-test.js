 ...
 *
 * Usage:
 *   node dev-test.js                  # test all examples
 *   node dev-test.js --filter=koa     # test only matching examples
 *   node dev-test.js --mode=preview   # test built preview servers
 *
 * Flow:
 *   1. rootSetup() — install deps & build dist/ if missing
 *   2. Kill any process on ROOT_PORT (5173)
 *   3. For each example:
 ...
 *   4. Print results table; exit 1 if any test failed
 *
 * Environment:
